"""
Django settings for backery_app project.
...
MIDDLEWARE = [
    ...
    'backery_app.middleware.RequestCheckMiddleware',
]

ROOT_URLCONF = 'backery_app.urls'
...
WSGI_APPLICATION = 'backery_app.wsgi.application'
